...
;; Vote weight is proportional to token balance committed to the vote
(define-public (vote
    (proposal-id uint)
    (vote-for bool)
    (amount uint)
...
;; Gets individual vote information
